...
class _MenuScreenState extends State<MenuScreen>
  ...
  var isSouthIndianMeal = false;
  var isNorthIndianList = false;
  var _other = false;
  var _other2 = false;
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: CupertinoSwitch(
                      ...
                      value: isSouthIndianMeal,
                      onChanged: (newValue) {
                        setState(() {
                          isSouthIndianMeal = newValue;
                          if (isSouthIndianMeal == true) {
                          } else {}
                        });
                      },
                    ),
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child: CupertinoSwitch(
                      activeColor: const Color(0xff7EDABF),
                      value: isNorthIndianList,
                      onChanged: (newValue) {
                        setState(() {
                          isNorthIndianList = newValue;
                          if (isNorthIndianList == true) {
                          } else {}
                        });
                      },
                    ),
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                      child: Container(
                    width: 50,
                    margin: const EdgeInsets.only(left: 10, right: 16, top: 30),
                    child: const TextField(
